...
class ContrastiveSWM(nn.Module):
    ...
    def __init__(
        ...
        self.transition_model = TransitionGNN(
            ...
            num_objects=num_objects,
            target_object_dim=target_object_dim,
...
class TransitionGNN(torch.nn.Module):
    ...
    def __init__(
        ...
        """
        target_object_dim: dimensionality of the representation of the object targeted by the action
        action_embed_dim: dimensionality of the encoding of the action
        """
...
class ActionEncoder(nn.Module):
    def __init__(self, action_dim, object_dim, embedding_dim):
        """
        action_dim: number of actions
        object_dim: dimensionality of the indicator for the object of the action
        embedding_dim: dimensionality of the encoding
        """
        super(ActionEncoder, self).__init__()
        self.action_embeddings = nn.Embedding(action_dim, embedding_dim)
        self.fc_object = nn.Linear(object_dim, embedding_dim)

    def forward(self, action, target_object):
        """
