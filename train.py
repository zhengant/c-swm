...
if __name__ == '__main__':
    ...
    parser.add_argument('--target-object-dim', type=int, default=4,
                        help='Dimensionality of the indicator for the object targeted by the action.')
    parser.add_argument('--action-embed-dim', type=int, default=8,
                        help='Dimensionality of the joint action/target object embedding.')
